...
```sh
[root@poc ec2-user]# mkfs.ext4 /dev/xvdf
...
```sh
[root@poc ec2-user]# vi index.html

[root@poc ec2-user]# pwd
/home/ec2-user

[root@poc ec2-user]# ls
index.html

[root@poc ec2-user]# mount /dev/xvdf /home/ec2-user/  <==== mount

```
- Mount permonently 
```sh
[root@poc etc]# vim /etc/fstab

/dev/xvdf /home/ec2-user/ ext4 defults  0 0  <=== line in end of 

[root@poc etc]# mount -a
...
```sh
[root@poc ec2-user]# touch test{0..100} <===== create 100 file at location /home/ec2-user
